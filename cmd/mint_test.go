...
func TestMintCredentialsWithFlags_KeyBasedApproach(t *testing.T) {
	...
	config := &Config{}
	err := mintCredentialsWithFlags(clientFactory(), config, cmd, "test-token", "env", "test-idp", keys, 0, false)
...
func TestMintCredentialsWithFlags_AllFlag(t *testing.T) {
	...
	config := &Config{}
	err := mintCredentialsWithFlags(client, config, cmd, "test-token", "env", "test-idp", nil, 0, true)
...
func TestMintCredentialsWithFlags_NoToken(t *testing.T) {
	...
	config := &Config{}
	err := mintCredentialsWithFlags(client, config, cmd, "", "env", "", nil, 0, false)
...
func TestMintCredentialsWithFlags_JSONOutput(t *testing.T) {
	...
	config := &Config{}
	err := mintCredentialsWithFlags(client, config, cmd, "test-token", "json", "test-idp", keys, 0, false)
...
func TestMintCredentialsWithFlags_WithDuration(t *testing.T) {
	...
	config := &Config{}
	err := mintCredentialsWithFlags(client, config, cmd, "test-token", "env", "test-idp", keys, duration, false)
...
func TestMintCredentialsWithFlags_EnvironmentTokens(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			config := &Config{}
			err := mintCredentialsWithFlags(client, config, cmd, "", "env", "", []string{"MINIO_CREDENTIALS"}, 0, false)
