...
// SetTestClientFactory overrides the global client factory for testing
func SetTestClientFactory(mockClient HTTPClient, serverURL string) func() {
	originalFactory := clientFactory
	clientFactory = func() *VoidkeyClient {
		return NewVoidkeyClient(mockClient, serverURL)
	}
